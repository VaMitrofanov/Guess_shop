        ...
        <div className="container mx-auto px-4 relative z-10 flex flex-col items-center gap-16">
          <div className="text-center space-y-6 max-w-3xl">
            <h1 className="text-5xl md:text-7xl font-black tracking-tight leading-tight uppercase">
              Лучший способ купить <span className="gold-text italic">Robux</span>
            </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
            <div className="space-y-4">
              <span className="text-[#00f2fe] font-black tracking-widest text-sm uppercase">Лучшие предложения</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {products.map((product) => (
              <div 
                key={product.id} 
                className="group relative bg-[#0d1117] border border-white/5 rounded-3xl p-8 hover:border-[#00f2fe]/30 transition-all flex flex-col gap-8 shadow-2xl"
              >
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-5xl font-black text-[#00f2fe] tracking-tighter">{product.robux}</span>
                ...
                <Link 
                  ...
                  className="w-full h-14 bg-white/10 hover:bg-[#00f2fe] hover:text-black rounded-2xl flex items-center justify-center font-bold transition-all"
                >
                  ВЫБРАТЬ
                </Link>

                <div className="absolute top-4 right-6 opacity-0 group-hover:opacity-100 transition-opacity">
                    <Check className="w-5 h-5 text-[#00f2fe]" />
                </div>
              </div>
            ))}
          </div>
      ...
      <footer className="border-t border-white/5 py-12 bg-black text-center space-y-6">
          <div className="container mx-auto px-4">
            <p className="text-zinc-500 text-sm font-medium">
              GUESS-SHOP не связан с Roblox Corporation.
            </p>
