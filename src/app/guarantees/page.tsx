    ...
    <main className="min-h-screen bg-[#0a0a0b] text-white">
      ...
      <section className="pt-32 pb-48 px-4">
        <div className="container mx-auto">
          ...
          >
            <span className="text-[#ffb800] font-black tracking-widest text-sm uppercase">Надежность прежде всего</span>
            <h1 className="text-5xl md:text-8xl font-black uppercase leading-tight tracking-tighter">
                МЫ ДАЕМ <br/> <span className="gold-gradient bg-clip-text text-transparent italic">100% ГАРАНТИЙ</span>
            </h1>
          </motion.div>
          ...
          >
            {guarantees.map((g, index) => (
              <motion.div 
                key={index}
                variants={item}
                className="bg-[#141416]/50 border border-white/5 p-10 rounded-sm hover:border-[#ffb800]/50 transition-all flex flex-col gap-10 group"
              >
          ...
          <motion.div 
            ...
            className="mt-32 p-16 bg-[#ffb800] text-black rounded-lg text-center space-y-8 overflow-hidden relative"
          >
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[200px] font-black opacity-10 pointer-events-none select-none tracking-tighter italic">
                ROBUX
            </div>
          </motion.div>
        </div>
