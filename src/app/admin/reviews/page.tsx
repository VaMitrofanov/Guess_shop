    ...
    <main className="min-h-screen bg-[#0a0a0b]">
        ...
        <div className="container mx-auto px-4 py-12">
            <div className="flex items-center gap-4 mb-8">
                ...
                <h1 className="text-2xl font-black uppercase italic gold-gradient bg-clip-text text-transparent">Управление Отзывами</h1>
            </div>

            <div className="bg-[#141416] border border-white/5 rounded-[2rem] shadow-2xl">
