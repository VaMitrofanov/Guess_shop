...
> **Roblox недоступен с российского хоста 28.08.2026:** поиск по нику на сайте отвечал
> «Такого пользователя Roblox не нашли» про существующие аккаунты — и отвечал через 25 секунд;
> в ботах то же самое после полутора минут. Причина не в коде: API-хосты Roblox (`users`,
...
> ссылке или ID геймпасса, который в `/guide` есть с 24.08. Детали —
