...
12.08.2026 аватары Roblox в ЛК снова проходят через встроенный image endpoint Next.js,
а не загружаются браузером напрямую с CDN; при ошибке CDN карточка показывает штатную
иконку профиля вместо broken-image.
