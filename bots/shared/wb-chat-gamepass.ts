 ...
 *    выставлен на продажу и стоить ровно ту цену, которую мы просим (те же
 *    ±2 R$, что и в ботах). Закрытая игра и возрастной рейтинг — не причина
 *    отказа (решение владельца 21.09.2026): выкуп ручной, нужен только Pass ID.
