 ...
 *
 * Зеркало: src/lib/roblox-purchase-script.ts (bots/ и src/ не импортируют друг друга) —
 * менять синхронно.
 */
...
export interface GamepassPurchaseScriptInput {
  ...
  /** Buyer-price, проверенная сервером поверх правильной base-price — [ЦЕНА-СТОП]. */
...
/**
 * Собирает скрипт покупки для браузера, залогиненного донором.
 *
